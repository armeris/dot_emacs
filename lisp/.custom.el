(custom-set-variables
 ...
 '(connection-local-criteria-alist
    '(((:application eshell)
       ...
       ((:application tramp :machine "K6W1RW936J")
         tramp-connection-local-darwin-ps-profile)
       ((:application tramp)
